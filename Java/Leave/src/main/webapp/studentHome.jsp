										...
										<form class="card" action="" method="post">
											<div class="card-body p-6">
												...
												<div class="form-group">
													...
													<select class="form-control custom-select" id="roleSelect" name="leaveFromPlace">
												...
												<div class="form-group">
													...
													<select class="form-control custom-select" id="roleSelect" name="leaveType">
												...
												<div class="form-group">
													...
													<%
														...
														con=new Connect();
														rs=con.SelectData("select facultyID,facultyName from faculty_master");
														mtdt=rs.getMetaData();
														while(rs.next())
														{
															int ID = rs.getInt("facultyID");
													%>
														<option value="<%= ID%>"><%= rs.getString("facultyName")%></option>
													<%
																}
												...
												<div class="form-footer">
													...
													<button type="submit" class="btn btn-primary btn-block"
														id="submitLink" value="submit" name="studentApplyLeave">Submit</button>
												</div>
											</div>
											<%
												try {
												...
												if (con.CheckData(
												"select * from leave_record where appID='" + appID + "' and appRole='student'")) {
