    ...
    <div class="uk-modal-container" style="padding: 0px; margin: 0px; background-color: #edf2fa;">
        <div class="container" style="height: 100%; width: 100%; padding: 0px; margin: 0px;">
            <div class="row" style="height: 100%; width: 100%;padding: 0px; margin: 0px;">
                <div class="col-sm-4 col-md-3 col-lg-2" style="padding: 10px; margin-top: 0px; background-color: #c7c9fb;">
                    <div class="col-lg order-lg-first">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a href="" class="nav-link"><i class="fe fe-user"></i> Edit Profile</a>
                            </li>
                            <li class="nav-item">
                ...
                <div class="col-sm-8 col-md-9 col-lg-10" style="margin: 0px; padding: 0px; width: 100%;">
                    <form class="uk-card-default uk-center" style="padding: 10px; width: 100%; margin: 0px;" action=""
                        method="post">
                        <div class="col-12">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div style="padding: 5px; text-align: center; margin: 0px;">
                                                    <label class="form-label" style="padding: 5px; text-align: center; margin: 0px;">From</label>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-1" style="padding: 5px; text-align: center; margin: 0px;">
                                                    <label class="form-label" style="padding: 5px; text-align: center; margin: 0px;">To</label>
                                                </div>
                                                <div class="col-sm-5">
                                                    <div class="row gutters-xs">
                                                        <div class="col-5">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-lg-12">
                                                <div class="form-label">Upload the Proof Document</div>
                                ...
                                <div class="card-footer col-lg-2">
