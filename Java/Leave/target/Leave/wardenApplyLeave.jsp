				...
				<div class="col-sm-4 col-md-3 col-lg-2"
					...
					<div class="col-lg order-lg-first">
						<ul class="nav nav-tabs">
							...
							<li class="nav-item">
								<a href="wardenApplyLeave.jsp" class="nav-link active"><i class="fe fe-plus"></i> Apply
									for Leave</a>
							</li>
							<li class="nav-item">
							...
							<li class="nav-item">
								<a href="wardenRemoveStudent.jsp" class="nav-link"><i uk-icon="icon: close"></i> Remove
									Student</a>
							</li>
							<li class="nav-item">
						...
						<div class="page-single" style="width: 100%;">
							<div class="container">
											...
											<div class="card-body p-6">
												...
												<div class="form-group">
													...
													<textarea type="reason" class="form-control" id="leaveReason"
														name="wardenReason" aria-describedby="leaveReason"
												...
												<div class="form-footer">
													<button type="submit" class="btn btn-primary btn-block"
														...
														name="wardenApplyLeave">Submit</button>
												</div>
											</div>
											<%
												try {
								...
								<script type="text/javascript">
									function date_check() {
										var leaveFrom_date = document.wardenApplyLeave.leaveFromMonth.value + "-" + document.wardenApplyLeave.leaveFromDay.value + "-" + document.wardenApplyLeave.leaveFromYear.value;
										var d = new Date();
										...
										var leaveTo_date = document.wardenApplyLeave.leaveToMonth.value + "-" + document.wardenApplyLeave.leaveToDay.value + "-" + document.wardenApplyLeave.leaveToYear.value;
										var d = new Date();
										var today = (d.getMonth() + 1) + "-" + d.getDate() + "-" + d.getFullYear();
