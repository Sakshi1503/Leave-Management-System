				...
				<div class="col-sm-4 col-md-3 col-lg-2" style="padding: 10px; margin-top: 0px; background-color: #b3d9ff; height: -webkit-fill-available;">
					<div class="col-lg order-lg-first">
						<ul class="nav nav-tabs flex-column flex-lg-column">
							...
							<li class="nav-item">
								<a href="facultyApproveStudent.html" class="nav-link active"><i class="fe fe-check-circle"></i> Approve Student</a>
							</li>
							<li class="nav-item">
								<a href="facultyRemoveStudent.html" class="nav-link"><i uk-icon="icon: close"></i> Remove Student</a>
							</li>
							<li class="nav-item">
