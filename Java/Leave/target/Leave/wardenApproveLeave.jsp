    ...
    <div class="page" style="padding: 0px; margin: 0px; height: -webkit-fill-available; background-color: #edf2fa;">
        <div class="container" style="padding: 0px; margin: 0px; height: -webkit-fill-available;">
                ...
                <div class="col-sm-4 col-md-3 col-lg-2"
                    ...
                    <div class="col-lg order-lg-first">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a href="wardenApproveLeave.jsp" class="nav-link active"><i class="fe fe-check-circle"></i>
                                    Approve Leave</a>
                            </li>
                            <li class="nav-item">
            ...
            <%
			        ...
			        con=new Connect();
					int wardenID = 0;
                    ResultSet rs2 = con.SelectData("select wardenID from warden_master where wardenEmail = '"+ session.getAttribute("wardenUsername") +"';");
                    ResultSet rs3 = null;
                    if(rs2.next()){
                    	wardenID = rs2.getInt("wardenID");
                    }
                    rs = con.SelectData("select * from leave_record,student_master where appID = studentID and appRole='student' and appToID = "+ wardenID +" and appToRole='warden' and leaveApproved='no' and studentHosteller='yes';");
                    while(rs.next()){
