				...
				<div class="col-sm-4 col-md-3 col-lg-2"
					...
					<div class="col-lg order-lg-first">
						<ul class="nav nav-tabs">
							...
							<li class="nav-item">
								<a href="facultyLeaveRequests.jsp" class="nav-link active"><i class="fe fe-check-circle"></i>
									Your Leaves</a>
							</li>
							<li class="nav-item">
								...
								<div class="card"
									...
									<div class="table-responsive">
										<table
                                            ...
                                            rs = con.SelectData("select * from leave_record where appID = "+ facultyID +" and appRole='faculty';");
